...
;-
;*****************************************************************************
PRO MAIN_GLCF_Landsat_Preprocess1, Landsat_DIR, ENVIFile_DIR
  ...
  ; Temporary variables, just for testing
    Landsat_DIR  = '/Volumes/D2/tm/1990/TM1990_test/'
    ENVIFile_DIR = '/Volumes/D2/tm/1990/TM1990_test_unzip/'
  ; Temporary variables, just for testing  
  ; ###########################################################################
  ...
  FOR i=0,SceneCount-1 DO BEGIN
    ...
    ;***************************************************************************
    BandFiles = FILE_SEARCH(SceneDIR[i],'*.tif', COUNT=gzFileCount,/TEST_READ, /FULLY_QUALIFY_PATH)
