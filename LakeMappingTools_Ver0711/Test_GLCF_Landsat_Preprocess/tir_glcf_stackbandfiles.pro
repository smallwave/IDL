...
;*******************************************************************************
;
FUNCTION Tir_GLCF_StackBandFiles, BandFileNames, nBands, LandsatMetaFile, SensorID,$
...
;  Test_Tir_GLCF_FileHeaderEdit, STACK_FID, SensorID, LandsatMetaFile
  Test_GLCF_RadCoeff_TM, LandsatMetaFile, Gains=Gains, Offsets=Offsets,$
                            SunAzimuth=SunAzimuth, SunElev=SunElev, TirGains=TirGains, TirOffsets= TirOffsets
  ...
  Sensor = 'Landsat TM'
  BandNames = ['Band 6']
  ENVI_ASSIGN_HEADER_VALUE,FID=STACK_FID,KEYWORD='sensor type',VALUE=Sensor
  ENVI_ASSIGN_HEADER_VALUE,FID=STACK_FID,KEYWORD='wavelength units',VALUE=Wavelength_units
  ENVI_ASSIGN_HEADER_VALUE,FID=STACK_FID,KEYWORD='band names',VALUE=BandNames
  ENVI_ASSIGN_HEADER_VALUE,FID=STACK_FID,KEYWORD='wavelength',VALUE=Wavelength,PRECISION=6
  ENVI_ASSIGN_HEADER_VALUE,FID=STACK_FID,KEYWORD='fwhm',VALUE=FWHM_wavelength,PRECISION=6
  ENVI_ASSIGN_HEADER_VALUE,FID=STACK_FID,KEYWORD='data gain values',VALUE=TIRGains,PRECISION=5
  ENVI_ASSIGN_HEADER_VALUE,FID=STACK_FID,KEYWORD='data offset values',VALUE=TIROffsets,PRECISION=5
  ENVI_ASSIGN_HEADER_VALUE,FID=STACK_FID,KEYWORD='Sun azimuth angle',VALUE=SunAzimuth,PRECISION=5
  ENVI_ASSIGN_HEADER_VALUE,FID=STACK_FID,KEYWORD='Sun elevation angle',VALUE=SunElev,PRECISION=5
  ; Write the values to the file header
  ENVI_WRITE_FILE_HEADER, STACK_FID
