...
FUNCTION MAPPING_SubSetDEM_Slope_Shade, DEMFile,Landsat_FID,DEM=DEMBand,SLOPE=SlopeBand,SHADE=ShadeBand
   ...
   ; ENVI_OPEN_FILE, LandsatFile, R_FID=Landsat_FID
    ...
    ; perform shade relief of a DEM file
    ENVI_DOIT, 'TOPO_DOIT', FID = DEM_FID,POS=0,DIMS=DEM_DIMS,BPTR=0, $
               OUT_BNAME='SLOPE', PIXEL_SIZE=DEM_PS,IN_MEMORY=1,R_FID=Slope_FID
    ...
    IF(NS EQ DEM_NS AND NL EQ DEM_NL) THEN BEGIN
      ...
      SlopeBand= ENVI_GET_DATA(FID=Slope_FID,DIMS=DIMS, POS=[0])
...
;       ENVI_FILE_MNG,ID=Landsat_FID,/REMOVE
    ...
    Slope      = ENVI_GET_DATA(FID=Slope_FID,DIMS=DIMS, POS=[0])
    DEMBand    = CONGRID(TEMPORARY(DEM),  NS, NL, /INTERP)
    ShadeBand  = CONGRID(TEMPORARY(Shade),NS, NL, /INTERP)
    SlopeBand  = CONGRID(TEMPORARY(Slope),NS, NL, /INTERP)
    ENVI_FILE_MNG,ID=DEM_FID,    /REMOVE
    ENVI_FILE_MNG,ID=Shade_FID,  /REMOVE
    ENVI_FILE_MNG,ID=Slope_FID,  /REMOVE
;    ENVI_FILE_MNG,ID=Landsat_FID,/REMOVE
